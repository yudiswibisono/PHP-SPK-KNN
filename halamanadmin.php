<?php
	...
	$res=mysqli_query($conn,$q);	
		...
		$q2="UPDATE rumus SET status='aktif' WHERE nama='". $_GET["rumus"] ."'";
		//echo $q2;
									...
									<div class="col-sm-10">
										...
										<option></option>
											<?php
												...
												$q="SELECT nama,status FROM rumus";
												...
												while ($row=mysqli_fetch_assoc($res))
												{
													...
													?>
													  <option <?php echo $selected;?> value="<?php echo $row["nama"];?>">
														<?php
															echo $row["nama"];
														?>
													  </option>
										...
										<button style="margin-top:10px" type="submit" class="btn btn-primary"> Ganti Rumus </button>
									</div>
								</div>	
