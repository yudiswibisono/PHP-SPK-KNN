						...
						<div class="card-body">
							<table class="table">
							  ...
							  <tbody>
							    <?php
									$no=1;
									$q="SELECT *,DATE_FORMAT(tanggal,'%d-%M-%Y') as tgl FROM historymotorbaru WHERE id_user='". $_SESSION["id_user"] ."'";
									...
									while ($row=mysqli_fetch_assoc($res))
									{
										...
										<tr>
										  ...
										  <td>
										    <a class="btn btn-primary" href="motorbaru.php?<?php echo $row["parameter"];?>">Cari</a>
											<a class="btn btn-danger" href="deleteriwayatmotorbaru.php?id=<?php echo $row["id"];?>">Hapus</a>
										  </td>
										  </tr>
										<?php
									}
